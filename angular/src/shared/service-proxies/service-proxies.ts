...
@Injectable()
export class AirplaneServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    create(input: CreateAirplaneDto | null | undefined): Observable<AirplaneDto> {
        let url_ = this.baseUrl + "/api/services/app/Airplane/Create";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<AirplaneDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<AirplaneDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<AirplaneDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = AirplaneDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<AirplaneDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAirplanes(permission: string | null | undefined): Observable<ListResultDtoOfAirplaneListDto> {
        let url_ = this.baseUrl + "/api/services/app/Airplane/GetAll?";
        if (permission !== undefined)
            url_ += "Permission=" + encodeURIComponent("" + permission) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            return this.processGetAirplanes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAirplanes(<any>response_);
                } catch (e) {
                    return <Observable<ListResultDtoOfAirplaneListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfAirplaneListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAirplanes(response: HttpResponseBase): Observable<ListResultDtoOfAirplaneListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = ListResultDtoOfAirplaneListDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfAirplaneListDto>(<any>null);
    }
     ...
     * @return Success
     */
    update(input: AirplaneDto | null | undefined): Observable<AirplaneDto> {
        let url_ = this.baseUrl + "/api/services/app/Airplane/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<AirplaneDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    delete(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Airplane/Delete?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getAirplaneForEdit(id: number | null | undefined): Observable<GetAirplaneForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Airplane/GetAirplaneForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAirplaneForEdit(<any>response_);
                } catch (e) {
                    return <Observable<GetAirplaneForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetAirplaneForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetAirplaneForEdit(response: HttpResponseBase): Observable<GetAirplaneForEditOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = GetAirplaneForEditOutput.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetAirplaneForEditOutput>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: number | null | undefined): Observable<AirplaneDto> {
        let url_ = this.baseUrl + "/api/services/app/Airplane/Get?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGet(response: HttpResponseBase): Observable<AirplaneDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfAirplaneDto> {
        let url_ = this.baseUrl + "/api/services/app/Airplane/GetAll?";
        if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        if (skipCount !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfAirplaneDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfAirplaneDto>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfAirplaneDto> {
        ...
        return _observableOf<PagedResultDtoOfAirplaneDto>(<any>null);
    }
}
...
export class AirplaneDto implements IAirplaneDto {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.numberPassengers = data["numberPassengers"];
    ...
    toJSON(data?: any) {
        ...
        data["numberpassengers"] = this.numberPassengers;
...
export interface ICreateAirplaneDto {
    code: string;
    name: string;
    model: string;
    numberPassengers: number ;
...
export class CreateAirplaneDto implements ICreateAirplaneDto {
    code: string;
    name: string;
    model: string;
    numberPassengers: number;

    constructor(data?: ICreateAirplaneDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateAirplaneDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateAirplaneDto();
        result.init(data);
        return result;
    }
...
export class ListResultDtoOfAirplaneListDto implements IListResultDtoOfAirplaneListDto {
    items: AirplaneListDto[] | undefined;

    constructor(data?: IListResultDtoOfAirplaneListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"])
                    this.items.push(AirplaneListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfAirplaneListDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfAirplaneListDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ListResultDtoOfAirplaneListDto {
        const json = this.toJSON();
        let result = new ListResultDtoOfAirplaneListDto();
        result.init(json);
        return result;
...
export interface IListResultDtoOfAirplaneListDto {
    items: AirplaneListDto[] | undefined;
}

export class AirplaneListDto implements IAirplaneListDto {
    id: number | undefined;
    code: string | undefined;
    name: string | undefined;
    model: string | undefined;
    numberPassengers: number | undefined;
    creationTime: moment.Moment | undefined;

    constructor(data?: IAirplaneListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AirplaneListDto {
        data = typeof data === 'object' ? data : {};
        let result = new AirplaneListDto();
        result.init(data);
        return result;
    }
...
export interface IAirplaneListDto {
...
export class PagedResultDtoOfAirplaneDto implements IPagedResultDtoOfAirplaneDto {
    ...
    clone(): PagedResultDtoOfAirplaneDto {
        const json = this.toJSON();
        let result = new PagedResultDtoOfAirplaneDto();
        result.init(json);
        return result;
...
export interface IAirplaneEditDto {
    id: number;
    code: string;
    name: string;
    model: string;
...
export class AirplaneEditDto implements IAirplaneEditDto {
    id: number;
    code: string;
    name: string;
    model: string;
    ...
    constructor(data?: IAirplaneEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AirplaneEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new AirplaneEditDto();
        result.init(data);
        return result;
    }
...
export class GetAirplaneForEditOutput implements IGetAirplaneForEditOutput {
    airplane: AirplaneEditDto | undefined;
   

    constructor(data?: IGetAirplaneForEditOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.airplane = data["airplane"] ? AirplaneEditDto.fromJS(data["airplane"]) : <any>undefined;
            
           
        }
    }

    static fromJS(data: any): GetAirplaneForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetAirplaneForEditOutput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["airplane"] = this.airplane ? this.airplane.toJSON() : <any>undefined;
        
        
        return data;
    }

    clone(): GetAirplaneForEditOutput {
        const json = this.toJSON();
        let result = new GetAirplaneForEditOutput();
        result.init(json);
        return result;
...
export interface IGetAirplaneForEditOutput {
    airplane: AirplaneEditDto | undefined;
